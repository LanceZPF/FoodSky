...
def evaluate_with_gpt4(question, answer, ground_truth):
    ...
    evaluations = {}
    criteria = {
        "Logic": "回答在足够凝练的基础上事理逻辑上是正确的吗？请就回答的逻辑正确性给一个0-100之间的数字评分：",
        "Professional": "回答在足够凝练的基础上体现了足够的专业性吗？请就回答的知识专业性给一个0-100之间的数字评分：",
        "Informative": "回答在尽可能短的情况下给出了足够的信息密度吗？请就回答的信息密度给一个0-100之间的数字评分：",
        "Fluent": "回答是否流畅？请就回答的表达流畅度给一个0-100之间的数字评分：?"
    }
...
def main():
    questions_path = 'cookdiet_qa25.json'
    ...
    for i,question in enumerate(questions):
        ...
        answer_other = df_other.iloc[answer_i, 0][:400]
